...
database         = os.environ.get("GLUE_DB", "")
...
CRITICAL_COLUMNS = {
    "silver_statistics":    ["video_id", "title", "channel_title", "views", "region"],
    "silver_reference_data": ["id", "region"],
}
...
def check_value_ranges(df: pd.DataFrame, table_name: str) -> list:
    ...
    if table_name != "silver_statistics":
        return results
